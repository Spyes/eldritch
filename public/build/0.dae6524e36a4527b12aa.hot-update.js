...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentActions = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../actions/componentActions\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  function Entity(props) {
	    ...
	    _this.addComponent = function (component, key) {
	      ...
	      switch (component.get('name')) {
	        case 'Stats':
	          _this.props.dispatch((0, _componentActions.addComponentToEntity)());

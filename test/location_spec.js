...
import * as actions from '../public/js/actions/locationActions';
import location from '../public/js/reducers/locationReducer';
...
describe("Location", () => {
  ...
  describe("Reducer", () => {
    ...
    describe("Basics", () => {
      ...
      let store = createStore(location, initialState);
